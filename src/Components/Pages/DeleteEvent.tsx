      ...
      {events.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
          {events.map((event) => (
            <div
              key={event.id}
              className="bg-white rounded-xl shadow-sm hover:shadow-lg  overflow-hidden border border-gray-100"
            >
              <div className="p-5">
                <div className="flex flex-col gap-3 mb-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="bg-blue-10 text-blue-800 text-xs font-medium px-2.5 py-0.5 rounded-full flex items-center">
                ...
                <div className="space-y-3 mb-4">
                  <div className="flex items-start gap-3">
                    <MapPin className="text-gray-500h-5 w-5 flex-shrink-0 mt-0.5" />
                    <div>
